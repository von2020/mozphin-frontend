        ...
        <ScrollView
          ...
          <View style={{ marginVertical: 30 }}>
            <TouchableOpacity style={styles.optionContainer} onPress={()=> this.props.navigation.navigate("AirtimeNData")}>
                ...
                <View>
                <Text style={{ fontSize: 16, color: "#002A14", fontWeight: "600" }}>Airtime/Data</Text>
                <Text style={{ fontSize: 12, color: "#002A14", width: 250, fontWeight: "400" }}>Purchase Airtime and Data for all local networks</Text>
                </View>

                <View style={{ marginEnd: 10, marginStart: 5, marginVertical: 20,  }}>
                <IconArrow/>
                </View>
                </View>
            </TouchableOpacity>

            <TouchableOpacity style={styles.optionContainer} onPress={()=> this.props.navigation.navigate("SelectUtility")}>
                <View style={{ margin: 5, }}>
                <Icon2/>
                </View>
                <View style={{ flexDirection: "row", marginStart: 6 }}>
                <View>
                <Text style={{ fontSize: 16, color: "#002A14", fontWeight: "600" }}>Utility Payments</Text>
                <Text style={{ fontSize: 12, color: "#002A14", width: 250, fontWeight: "400" }}>Make utilities bills payments</Text>
                </View>
                <View style={{ marginEnd: 10, marginStart: 5, marginVertical: 20,  }}>
                <IconArrow/>
                </View>
            ...
            <TouchableOpacity style={styles.optionContainer} onPress={()=> this.props.navigation.navigate("SelectCableSub")}>
                <View style={{ margin: 5, }}>
                <Icon3/>
                </View>
                <View style={{ flexDirection: "row", marginStart: 6 }}>
                <View>
                <Text style={{ fontSize: 16, color: "#002A14", fontWeight: "600" }}>Cable Subscription</Text>
                <Text style={{ fontSize: 12, color: "#002A14", width: 250, fontWeight: "400" }}>Easily pay for cable subscriptions</Text>
                </View>
            ...
            <TouchableOpacity style={styles.optionContainer} onPress={()=> this.props.navigation.navigate("SelectBetVendor")}>
                <View style={{ margin: 5, }}>
                <Icon4/>
                </View>
                <View style={{ flexDirection: "row", marginStart: 6 }}>
                <View>
                <Text style={{ fontSize: 16, color: "#002A14", fontWeight: "600" }}>Betting</Text>
                <Text style={{ fontSize: 12, color: "#002A14", width: 250, fontWeight: "400" }}>Fund your betting wallets</Text>
                </View>
            ...
            <TouchableOpacity style={styles.optionContainer} onPress={()=> this.props.navigation.navigate("QRCode")}>
                <View style={{ margin: 5, }}>
                <Icon6/>
                </View>
                <View style={{ flexDirection: "row", marginStart: 6 }}>
                <View>
                <Text style={{ fontSize: 16, color: "#002A14", fontWeight: "600" }}>QR Payments</Text>
                <Text style={{ fontSize: 12, color: "#002A14", width: 250, fontWeight: "400" }}>Scan QR codes to make payments</Text>
                </View>
                <View style={{ marginEnd: 10, marginStart: 5, marginVertical: 20,  }}>
                <IconArrow/>
                </View>
