      ...
      >
        ...
        <View>
            ...
            <View style={styles.emailTextStyleView_}>
              ...
              <Text style={{color: "#045135", fontWeight: "700", fontSize: 18, width: width * 0.8, textAlign: "justify", marginTop: 15, lineSpacing: 1, textDecorationLine: "underline",  }}>Privacy Policy</Text>
              <Text style={{color: "#045135", fontWeight: "100", fontSize: 15, width: width * 0.8, textAlign: "justify", marginTop: 5, lineSpacing: 1 }}>
              <Text style={{color: "#045135", fontWeight: "700", fontSize: 15, width: width * 0.8, textAlign: "justify", marginTop: 25, lineSpacing: 1 }}>Our Vision{"\n"}</Text>
                    To become a Global Leader in the provision of Retail Financial Services across Africa.{"\n\n"}
                    <Text style={{color: "#045135", fontWeight: "700", fontSize: 15, width: width * 0.8, textAlign: "justify", marginTop: 25, lineSpacing: 1 }}>Our Mission{"\n"}</Text>
                    To engage the best-in-practice Human and Scientific methods, through a conducive working environment at all levels.{"\n\n"}
                    <Text style={{color: "#045135", fontWeight: "700", fontSize: 15, width: width * 0.8, textAlign: "justify", marginTop: 25, lineSpacing: 1 }}>Objectives{"\n"}</Text>
                    To attain the highest standard in retail banking in Nigeria
                    To provide simplest solution
                    To raise professionals
                    To prove to everyone around us that greatness is not by birth{"\n\n"}
                    <Text style={{color: "#045135", fontWeight: "700", fontSize: 15, width: width * 0.8, textAlign: "justify", marginTop: 25, lineSpacing: 1 }}>Core Value{"\n"}</Text>
                    <Text style={{color: "orange", fontWeight: "700", fontSize: 15, width: width * 0.8, textAlign: "justify", marginTop: 25, lineSpacing: 1 }}>*{" "}</Text>Synergy{"\n"}
                    <Text style={{color: "orange", fontWeight: "700", fontSize: 15, width: width * 0.8, textAlign: "justify", marginTop: 25, lineSpacing: 1 }}>*{" "}</Text>Integrity{"\n"}
                    <Text style={{color: "orange", fontWeight: "700", fontSize: 15, width: width * 0.8, textAlign: "justify", marginTop: 25, lineSpacing: 1 }}>*{" "}</Text>Motivation{"\n"}
                    <Text style={{color: "orange", fontWeight: "700", fontSize: 15, width: width * 0.8, textAlign: "justify", marginTop: 25, lineSpacing: 1 }}>*{" "}</Text>Purpose{"\n"}
                    <Text style={{color: "orange", fontWeight: "700", fontSize: 15, width: width * 0.8, textAlign: "justify", marginTop: 25, lineSpacing: 1 }}>*{" "}</Text>Leadership{"\n"}
                    <Text style={{color: "orange", fontWeight: "700", fontSize: 15, width: width * 0.8, textAlign: "justify", marginTop: 25, lineSpacing: 1 }}>*{" "}</Text>Empathy
                    </Text>
              </View>
