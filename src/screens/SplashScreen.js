    ...
    return (
        ...
        <Carousel
          ...
          inactiveSlideScale={1}>
              ...
              <TouchableOpacity onPress={this.skipInfoStartUp.bind(this)} style={{alignSelf: "center", width: width * 0.8, height: 50, backgroundColor: "green", borderRadius: 18, marginBottom: 5 }}>
              ...
              <TouchableOpacity onPress={this.skipInfoStartUp.bind(this)} style={{alignSelf: "center", marginStart: 20}}>
                <Text style={styles.getStartedSmall}>Register</Text>
              </TouchableOpacity>

              <TouchableOpacity onPress={this.skipInfoStartUp.bind(this)} style={{alignSelf: "center", marginEnd: 20}}>
        ...
        <LinearGradient
              ...
              <TouchableOpacity onPress={this.skipInfoStartUp.bind(this)} style={{alignSelf: "center", width: width * 0.8, height: 50, backgroundColor: "green", borderRadius: 18, marginBottom: 5, opacity: 1 }}>
                <Text style={styles.getStarted}>SIGN IN</Text>
              </TouchableOpacity>
              <View
                    style={{
